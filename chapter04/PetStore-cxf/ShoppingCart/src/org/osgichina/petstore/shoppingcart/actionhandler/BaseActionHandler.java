...
public abstract class BaseActionHandler implements ActionHandler, BundleContextAware {
	...
	public void setBundleContext(BundleContext bundleContext) {
        ...
        ServiceTracker tracker = new ServiceTracker(bundleContext, CartDao.class.getName(), null) {
            @Override
            public Object addingService(ServiceReference reference) {
                Object result = super.addingService(reference);
                BaseActionHandler.this.cartDao = (CartDao) BaseActionHandler.this.bundleContext.getService(reference);
                return result;
            }
        };
        tracker.open();

        tracker = new ServiceTracker(bundleContext, ProductDao.class.getName(), null) {
            @Override
            public Object addingService(ServiceReference reference) {
                Object result = super.addingService(reference);
